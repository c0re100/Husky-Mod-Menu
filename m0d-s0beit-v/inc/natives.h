...
namespace ENTITY
{
	...
	static void DETACH_ENTITY(Entity entity, BOOL p1, BOOL noCollision) { invoke<Void>(0x961AC54BF0613F5D, entity, p1, noCollision); } // 0x961AC54BF0613F5D 0xC8EFCB41
...
namespace PED
{
	...
	static int CREATE_SYNCHRONIZED_SCENE(float x, float y, float z, float roll, float pitch, float yaw, Any p6) { return invoke<int>(0x8C18E0F9080ADD73, x, y, z, roll, pitch, yaw, p6); } // 0x8C18E0F9080ADD73 0xFFDDF8FA
...
namespace VEHICLE
{
	...
	static void _TASK_BRING_VEHICLE_TO_HALT(Vehicle vehicle, float distance, int killEngine, BOOL unknown) { invoke<Void>(0x260BE8F09E326A20, vehicle, distance, killEngine, unknown); } // 0x260BE8F09E326A20 0xCBC7D3C8
...
namespace GAMEPLAY
{
	...
	static BOOL INT_SCORES_SORTED(Hash hash, int amount) { return invoke<BOOL>(0x071E2A839DE82D90, hash, amount); } // 0x071E2A839DE82D90 0xFF6191E1
...
namespace CAM
{
	...
	static Cam CREATE_CAMERA_WITH_PARAMS(Hash camHash, float posX, float posY, float posZ, float rotX, float rotY, float rotZ, float p7, BOOL p8, Any p9) { return invoke<Cam>(0x6ABFA3E16460F22D, camHash, posX, posY, posZ, rotX, rotY, rotZ, p7, p8, p9); } // 0x6ABFA3E16460F22D 0x0688BE9A
	...
	static void SET_CAM_INHERIT_ROLL_VEHICLE(Cam cam, Any p1) { invoke<Void>(0x45F1DE9C34B93AE6, cam, p1); } // 0x45F1DE9C34B93AE6 0xE4BD5342
	...
	static void SET_FOLLOW_PED_CAM_VIEW_MODE(int p0) { invoke<Void>(0x5A4F9EDF1673F704, p0); } // 0x5A4F9EDF1673F704 0x495DBE8D
...
namespace WEAPON
{
	...
	static Any GET_PED_LAST_WEAPON_IMPACT_COORD(int* ped, Vector3* coord) { return invoke<Any>(0x6C4D0409BA1A2BC2, ped, coord); } // 0x6C4D0409BA1A2BC2 0x9B266079
...
namespace GRAPHICS
{
	...
	static void REQUEST_STREAMED_TEXTURE_DICT(char* textureDict, BOOL p2) { invoke<Void>(0xDFA2EF8E04127DD5, textureDict, p2); } // 0xDFA2EF8E04127DD5 0x4C9B035F
	...
	static BOOL _0x0AD973CA1E077B60(Hash p0) { return invoke<BOOL>(0x0AD973CA1E077B60, p0); } // 0x0AD973CA1E077B60 0x4D1EB0FB
...
namespace NETWORK
{
	...
	static int NETWORK_GET_PLAYER_INDEX(Ped Ped) { return invoke<int>(0x24FB80D107371267, Ped); } // 0x24FB80D107371267 0xBE1C1506
	static int NETWORK_GET_PARTICIPANT_INDEX(Any p0) { return invoke<int>(0x1B84DF6AF2A46938, p0); } // 0x1B84DF6AF2A46938 0xC4D91094
	...
	static Hash _NETWORK_HASH_FROM_GAMER_HANDLE(int* handle) { return invoke<Hash>(0x58575AC3CF2CA8EC, handle); } // 0x58575AC3CF2CA8EC
	...
	static Player NETWORK_GET_PLAYER_FROM_GAMER_HANDLE(int* playerHandle) { return invoke<Player>(0xCE5F689CF5A0A49D, playerHandle); } // 0xCE5F689CF5A0A49D 0x2E96EF1E
	static char* NETWORK_MEMBER_ID_FROM_GAMER_HANDLE(int* playerHandle) { return invoke<char*>(0xC82630132081BB6F, playerHandle); } // 0xC82630132081BB6F 0x62EF0A63
	static BOOL NETWORK_IS_GAMER_IN_MY_SESSION(int* playerHandle) { return invoke<BOOL>(0x0F10B05DDF8D16E9, playerHandle); } // 0x0F10B05DDF8D16E9 0x59127716
	static void NETWORK_SHOW_PROFILE_UI(int* playerHandle) { invoke<Void>(0x859ED1CEA343FCA8, playerHandle); } // 0x859ED1CEA343FCA8 0xF00A20B0
	...
	static void _0x6274C4712850841E(Any Entity, BOOL p1) { invoke<Void>(0x6274C4712850841E, Entity, p1); } // 0x6274C4712850841E 0xEA235081
	...
	static void NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(Ped ped, int netScene, char* animDictionary, char* animationName, float speed, float speedMultiplier, int duration, int flag, float playbackRate, Any p9) { invoke<Void>(0x742A637471BCECD9, ped, netScene, animDictionary, animationName, speed, speedMultiplier, duration, flag, playbackRate, p9); } // 0x742A637471BCECD9 0xB386713E
	static void NETWORK_ADD_ENTITY_TO_SYNCHRONISED_SCENE(Entity entity, int netScene, char* animDictionary, char* animName, float speed, float speedMulitiplier, int flag) { invoke<Void>(0xF2404D68CBC855FA, entity, netScene, animDictionary, animName, speed, speedMulitiplier, flag); } // 0xF2404D68CBC855FA 0x10DD636C
...
namespace DLC1
{
	...
	static BOOL GET_DLC_VEHICLE_DATA(int dlcWeapIndex, Any* outData) { return invoke<BOOL>(0x33468EDC08E371F6, dlcWeapIndex, outData); } // 0x33468EDC08E371F6 0xCF428FA4
